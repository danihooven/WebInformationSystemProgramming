  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col">
              <h5><strong><a href="/post/view/<?php echo(htmlentities( $post['id'] )); ?>"><?php echo(htmlentities( $post['title'] )); ?></strong></a></h5>
          </div>
          <div class="col text-right">
            <?php echo(htmlentities( time2str( $post['datestamp'] ) )); ?> by 
            <a href="/post/userList/<?php echo(htmlentities( $post['user_id'] )); ?>"><?php echo(htmlentities( $post['firstName'])); ?> <?php echo(htmlentities( $post['lastName'])); ?></a>
          </div>      
        </div>
      ...
      <div class="card-footer">
       <small>Filed under: <?php echo(htmlentities( $post['tags'] )); ?></small>
      </div>
    </div>
