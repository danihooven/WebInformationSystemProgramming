    ...
    <h1><?php echo(htmlentities($title)); ?></h1>
      <form>
        ...
        <div class="form-group">
          <label for="<?php echo(htmlentities($field)); ?>">
            <?php echo(htmlentities($description)); ?>
          </label>
          <input type="text" min="1" 
               id="<?php echo(htmlentities($field)); ?>" 
               name="<?php echo(htmlentities($field)); ?>"
               class="form-control" 
               value="<?php echo(htmlentities($employee[$field])); ?>" disabled 
          />
        </div>
        <?php  endforeach;?>
