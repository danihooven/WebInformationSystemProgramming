...
<div class="row mt-4">
  <div class="col-lg-12">
    ...
    echo "<h3>Fizz Buzz between $start and $stop</h3>";
      ...
      $ch = curl_init();
      curl_setopt($ch, CURLOPT_URL, "http://cs.franklin.edu/~whittakt/fizzbuzz.php");
      curl_setopt($ch, CURLOPT_POST, TRUE);
      curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
      curl_setopt($ch, CURLOPT_POSTFIELDS, array("start" => $start, "stop" => $stop));
      $some_data = curl_exec($ch);
    
      $myArr = json_decode($some_data, $flags = JSON_OBJECT_AS_ARRAY);
